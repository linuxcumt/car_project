...
if("TRUE" STREQUAL "TRUE")
  set(car_SOURCE_PREFIX /home/marc/catkin_ws/src/car)
  set(car_DEVEL_PREFIX /home/marc/catkin_ws/devel)
  set(car_INSTALL_PREFIX "")
  set(car_PREFIX ${car_DEVEL_PREFIX})
else()
  set(car_SOURCE_PREFIX "")
  set(car_DEVEL_PREFIX "")
  set(car_INSTALL_PREFIX /home/marc/catkin_ws/install)
...
if(NOT "/home/marc/catkin_ws/devel/include;/home/marc/catkin_ws/src/car/include " STREQUAL " ")
  set(car_INCLUDE_DIRS "")
  set(_include_dirs "/home/marc/catkin_ws/devel/include;/home/marc/catkin_ws/src/car/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'car' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'marc <marc@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'car' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marc/catkin_ws/src/car/${idir}'.  Ask the maintainer 'marc <marc@todo.todo>' to fix it.")
    endif()
    _list_append_unique(car_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "car_lib")
