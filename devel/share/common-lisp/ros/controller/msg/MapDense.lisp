...
(cl:defmethod cl:initialize-instance :after ((m <MapDense>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapDense)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controller-msg:<MapDense> is deprecated: use controller-msg:MapDense instead.")))

(cl:ensure-generic-function 'metadata-val :lambda-list '(m))
(cl:defmethod metadata-val ((m <MapDense>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller-msg:metadata-val is deprecated.  Use controller-msg:metadata instead.")
  (metadata m))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <MapDense>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller-msg:image-val is deprecated.  Use controller-msg:image instead.")
  (image m))

(cl:ensure-generic-function 'valid-val :lambda-list '(m))
(cl:defmethod valid-val ((m <MapDense>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller-msg:valid-val is deprecated.  Use controller-msg:valid instead.")
  (valid m))
