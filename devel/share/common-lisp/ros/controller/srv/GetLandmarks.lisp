...
(cl:defmethod cl:initialize-instance :after ((m <GetLandmarks-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLandmarks-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controller-srv:<GetLandmarks-request> is deprecated: use controller-srv:GetLandmarks-request instead.")))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <GetLandmarks-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller-srv:point-val is deprecated.  Use controller-srv:point instead.")
  (point m))

(cl:ensure-generic-function 'width_meter-val :lambda-list '(m))
(cl:defmethod width_meter-val ((m <GetLandmarks-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller-srv:width_meter-val is deprecated.  Use controller-srv:width_meter instead.")
  (width_meter m))

(cl:ensure-generic-function 'heigth_meter-val :lambda-list '(m))
(cl:defmethod heigth_meter-val ((m <GetLandmarks-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller-srv:heigth_meter-val is deprecated.  Use controller-srv:heigth_meter instead.")
  (heigth_meter m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLandmarks-request>)))
  ...
  "controller/GetLandmarksRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLandmarks-request)))
  "Returns string type for a service object of type 'GetLandmarks-request"
  "controller/GetLandmarksRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetLandmarks-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLandmarks-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controller-srv:<GetLandmarks-response> is deprecated: use controller-srv:GetLandmarks-response instead.")))

(cl:ensure-generic-function 'landmarks-val :lambda-list '(m))
(cl:defmethod landmarks-val ((m <GetLandmarks-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller-srv:landmarks-val is deprecated.  Use controller-srv:landmarks instead.")
  (landmarks m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLandmarks-response>)))
  ...
  "controller/GetLandmarksResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLandmarks-response)))
  "Returns string type for a service object of type 'GetLandmarks-response"
  "controller/GetLandmarksResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetLandmarks-response>)))
  ...
  (cl:format cl:nil "Landmark[] landmarks~%~%~%~%~%================================================================================~%MSG: controller/Landmark~%uint8 id~%float64 pos_x~%float64 pos_y~%float64 pos_z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetLandmarks-response)))
  "Returns full string definition for message of type 'GetLandmarks-response"
  (cl:format cl:nil "Landmark[] landmarks~%~%~%~%~%================================================================================~%MSG: controller/Landmark~%uint8 id~%float64 pos_x~%float64 pos_y~%float64 pos_z~%~%~%"))
