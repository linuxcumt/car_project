...
(cl:defmethod cl:initialize-instance :after ((m <Landmarks>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Landmarks)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car-msg:<Landmarks> is deprecated: use car-msg:Landmarks instead.")))
...
(cl:defmethod landmarks-val ((m <Landmarks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car-msg:landmarks-val is deprecated.  Use car-msg:landmarks instead.")
  (landmarks m))
