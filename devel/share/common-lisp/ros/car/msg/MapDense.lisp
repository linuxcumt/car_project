...
(cl:defmethod cl:initialize-instance :after ((m <MapDense>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapDense)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car-msg:<MapDense> is deprecated: use car-msg:MapDense instead.")))

(cl:ensure-generic-function 'metadata-val :lambda-list '(m))
(cl:defmethod metadata-val ((m <MapDense>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car-msg:metadata-val is deprecated.  Use car-msg:metadata instead.")
  (metadata m))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <MapDense>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car-msg:image-val is deprecated.  Use car-msg:image instead.")
  (image m))

(cl:ensure-generic-function 'valid-val :lambda-list '(m))
(cl:defmethod valid-val ((m <MapDense>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car-msg:valid-val is deprecated.  Use car-msg:valid instead.")
  (valid m))
