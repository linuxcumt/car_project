...
(cl:defmethod cl:initialize-instance :after ((m <GetLandmarks-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLandmarks-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car-srv:<GetLandmarks-request> is deprecated: use car-srv:GetLandmarks-request instead.")))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <GetLandmarks-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car-srv:point-val is deprecated.  Use car-srv:point instead.")
  (point m))

(cl:ensure-generic-function 'width_meter-val :lambda-list '(m))
(cl:defmethod width_meter-val ((m <GetLandmarks-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car-srv:width_meter-val is deprecated.  Use car-srv:width_meter instead.")
  (width_meter m))

(cl:ensure-generic-function 'heigth_meter-val :lambda-list '(m))
(cl:defmethod heigth_meter-val ((m <GetLandmarks-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car-srv:heigth_meter-val is deprecated.  Use car-srv:heigth_meter instead.")
  (heigth_meter m))
...
(cl:defclass <GetLandmarks-response> (roslisp-msg-protocol:ros-message)
  ((landmarks
    :reader landmarks
    :initarg :landmarks
    :type (cl:vector car-msg:Landmark)
   :initform (cl:make-array 0 :element-type 'car-msg:Landmark :initial-element (cl:make-instance 'car-msg:Landmark))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetLandmarks-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLandmarks-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name car-srv:<GetLandmarks-response> is deprecated: use car-srv:GetLandmarks-response instead.")))

(cl:ensure-generic-function 'landmarks-val :lambda-list '(m))
(cl:defmethod landmarks-val ((m <GetLandmarks-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car-srv:landmarks-val is deprecated.  Use car-srv:landmarks instead.")
  (landmarks m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetLandmarks-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'landmarks)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'car-msg:Landmark))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetLandmarks-response>)))
  ...
  (cl:format cl:nil "Landmark[] landmarks~%~%~%~%~%================================================================================~%MSG: car/Landmark~%uint8 id~%float64 pos_x~%float64 pos_y~%float64 pos_z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetLandmarks-response)))
  "Returns full string definition for message of type 'GetLandmarks-response"
  (cl:format cl:nil "Landmark[] landmarks~%~%~%~%~%================================================================================~%MSG: car/Landmark~%uint8 id~%float64 pos_x~%float64 pos_y~%float64 pos_z~%~%~%"))
