...
(cl:defmethod cl:initialize-instance :after ((m <Landmarks>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Landmarks)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name localization_msgs-msg:<Landmarks> is deprecated: use localization_msgs-msg:Landmarks instead.")))
...
(cl:defmethod landmarks-val ((m <Landmarks>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localization_msgs-msg:landmarks-val is deprecated.  Use localization_msgs-msg:landmarks instead.")
  (landmarks m))
