...
"""autogenerated by genpy from controller/GetLandmarksRequest.msg. Do not edit."""
import sys
...
class GetLandmarksRequest(genpy.Message):
  ...
  _type = "controller/GetLandmarksRequest"
...
def _get_struct_5d():
    ...
    return _struct_5d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from controller/GetLandmarksResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetLandmarksResponse(genpy.Message):
  ...
  _type = "controller/GetLandmarksResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  __slots__ = ['landmarks']
  _slot_types = ['controller/Landmark[]']
