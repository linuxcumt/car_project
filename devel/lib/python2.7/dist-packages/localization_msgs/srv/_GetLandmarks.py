...
"""autogenerated by genpy from localization_msgs/GetLandmarksRequest.msg. Do not edit."""
import sys
...
class GetLandmarksRequest(genpy.Message):
  ...
  _type = "localization_msgs/GetLandmarksRequest"
...
def _get_struct_5d():
    ...
    return _struct_5d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from localization_msgs/GetLandmarksResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetLandmarksResponse(genpy.Message):
  ...
  _type = "localization_msgs/GetLandmarksResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  __slots__ = ['landmarks']
  _slot_types = ['localization_msgs/Landmark[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = localization_msgs.msg.Landmark()
        _x = val1
        start = end
        end += 25
...
class GetLandmarks(object):
  _type          = 'localization_msgs/GetLandmarks'
